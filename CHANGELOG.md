...
- The integration URI continues to reference `${stageVariables.alias}` and the plugin continues to set the `alias` stage variable on managed stages — no migration needed for existing deployments.
